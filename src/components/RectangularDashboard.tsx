    ...
    <div className="min-h-screen pb-8">
      ...
      >
        ...
        <div className="relative">
          ...
          <div className="relative">
            ...
            <div className="relative py-8 z-10" style={{ paddingLeft: '20px', paddingRight: '16px' }}>
              <div className="flex items-center justify-between">
                {/* Logo */}
                <div>
                  <img 
      ...
      {groupStartDate && (
        ...
        >
          ...
          >
            <div className="relative">
              <div className="py-12" style={{ paddingLeft: '20px', paddingRight: '16px' }}>
          ...
          <div className="mx-1 mb-4">
            <div className="flex flex-col gap-2" style={{ paddingLeft: '20px' }}>
              {/* Days Since Donation */}
              <div className={`
