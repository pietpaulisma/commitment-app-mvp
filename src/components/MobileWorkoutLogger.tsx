      ...
      {hasFlexibleRestDay && (
        <div className="bg-black border-t border-white/10">
          <div className="px-4 py-6">
            <div className="bg-gradient-to-r from-green-600/20 to-emerald-600/20 border border-green-600/30 rounded-2xl p-4">
              <div className="flex items-center justify-between">
                ...
                <button 
                  className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-2xl text-sm font-medium transition-colors"
              ...
              <div className="grid grid-cols-2 gap-1 mx-1 mb-1">
                {popularExercises.map((exercise) => (
                  <button
                    ...
                    className="bg-black/70 backdrop-blur-xl hover:bg-black/80 text-white p-3 rounded-2xl transition-all duration-300 hover:scale-105 shadow-2xl hover:shadow-2xl border border-white/5 mb-1"
                  >
                    <div className="text-center">
                  ...
                  <div className="space-y-1">
                    {recoveryExercises.map((exercise) => (
                      <button
                        ...
                        className="w-full bg-black/70 backdrop-blur-xl hover:bg-black/80 text-white p-3 rounded-2xl transition-all duration-300 hover:scale-105 shadow-2xl hover:shadow-2xl border border-white/5 mb-1"
                      >
              ...
              <form onSubmit={handleSubmit} className="space-y-3">
                ...
                <div>
                  ...
                  <select 
                    ...
                    className="w-full px-4 py-3 border border-white/5 rounded-2xl focus:outline-none focus:ring-2 focus:ring-2 text-base bg-black/70 backdrop-blur-xl text-white mx-1"
                  >
                ...
                {selectedExercise && (
                  <>
                    {/* Exercise Info Card */}
                    <div className="bg-black/70 backdrop-blur-xl rounded-2xl p-4 shadow-2xl border border-white/5">
                      <div className="flex justify-between items-center">
                        <div>
                    ...
                    {/* Points Preview */}
                    {quantity && (
                      <div className="bg-black/70 backdrop-blur-xl rounded-2xl p-3 border border-white/5 shadow-2xl mx-1">
                        <div className="flex justify-between items-center">
                          <div>
                    ...
                    <button 
                      type="submit"
                      className="w-full text-black py-4 px-4 rounded-2xl transition-all duration-300 font-black text-lg shadow-sm hover:scale-105 btn-hover"
          ...
          <div className="py-3">
            ...
            <div className="px-1">
              ...
              <div className="grid grid-cols-2 gap-1 mb-3 mx-1">
                <div className="bg-black/70 backdrop-blur-xl p-3 border border-white/5 rounded-2xl shadow-2xl">
                  <div className="text-center">
              ...
              {getRecoveryPercentage() > 25 && (
                <div className="bg-black/70 backdrop-blur-xl border border-white/5 rounded-2xl p-3 mb-3 mx-1">
                  <div className="text-center">
              ...
              <div>
                ...
                {todaysLogs.length === 0 ? (
                  <div className="text-center py-8 bg-black/70 backdrop-blur-xl rounded-2xl">
                  ...
                  <div className="space-y-1">
                    {todaysLogs.slice(0, 5).map(log => {
                      ...
                      return (
                        <div key={log.id} className="bg-black/70 backdrop-blur-xl relative overflow-hidden rounded-2xl mb-1 shadow-2xl border border-white/5 hover:shadow-xl transition-all duration-300 mx-1">
