  ...
  return (
    <div className="relative min-h-screen bg-black">
      ...
      {!isScrolled && (
        <>
          {/* Mobile Landing Logo */}
          <div className="lg:hidden absolute top-4 left-4 z-50 transition-opacity duration-500">
            <img 
              src="/logo.png" 
              alt="The Commitment" 
          ...
          <div className="hidden lg:block absolute top-6 left-8 z-50 transition-opacity duration-500">
            <img 
              src="/logo.png" 
              alt="The Commitment" 
